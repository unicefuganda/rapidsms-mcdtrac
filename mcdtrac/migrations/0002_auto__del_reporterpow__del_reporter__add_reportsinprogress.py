...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ReportsInProgress'
        db.create_table('mcdtrac_reportsinprogress', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('provider', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healthmodels.HealthProvider'])),
        ...
        db.send_create_signal('mcdtrac', ['ReportsInProgress'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ReportsInProgress'
        db.delete_table('mcdtrac_reportsinprogress')
