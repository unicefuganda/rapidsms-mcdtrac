...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PoW.code'
        db.add_column('mcdtrac_pow', 'code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2),
                      keep_default=False)

        # Adding field 'PoW.district'
        db.add_column('mcdtrac_pow', 'district',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PoW.code'
        db.delete_column('mcdtrac_pow', 'code')

        # Deleting field 'PoW.district'
        db.delete_column('mcdtrac_pow', 'district_id')
