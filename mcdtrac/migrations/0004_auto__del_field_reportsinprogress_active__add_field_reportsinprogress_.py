...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReportsInProgress.active'
        db.delete_column('mcdtrac_reportsinprogress', 'active')

        # Adding field 'ReportsInProgress.state'
        db.add_column('mcdtrac_reportsinprogress', 'state',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ReportsInProgress.active'
        db.add_column('mcdtrac_reportsinprogress', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ReportsInProgress.state'
        db.delete_column('mcdtrac_reportsinprogress', 'state')
    ...
    models = {
        ...
        'mcdtrac.reportsinprogress': {
            'Meta': {'object_name': 'ReportsInProgress'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
