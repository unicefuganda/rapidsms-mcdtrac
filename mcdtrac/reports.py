...
class FHDMaterializedReport(FHDReportBase):
    ...
    pcv_pcv1_m = FHDReportMaterializedCol('pcv_pcv1_m')
    pcv_pcv1_f = FHDReportMaterializedCol('pcv_pcv1_f')
    pcv_pcv2_m = FHDReportMaterializedCol('pcv_pcv2_m')
    pcv_pcv2_f = FHDReportMaterializedCol('pcv_pcv2_f')
    pcv_pcv3_m = FHDReportMaterializedCol('pcv_pcv3_m')
    pcv_pcv3_f = FHDReportMaterializedCol('pcv_pcv3_f')
    dorm_male_1to4 = FHDReportMaterializedCol('dorm_male_1to4')
    dorm_female_1to4 = FHDReportMaterializedCol('dorm_female_1to4')
    dorm_male_5to14 = FHDReportMaterializedCol('dorm_male_5to14')
    dorm_female_5to14 = FHDReportMaterializedCol('dorm_female_5to14')
    ryg_red_male = FHDReportMaterializedCol('ryg_red_male')
    ryg_red_female = FHDReportMaterializedCol('ryg_red_female')
    ryg_yellow_male = FHDReportMaterializedCol('ryg_yellow_male')
    ryg_yellow_female = FHDReportMaterializedCol('ryg_yellow_female')
    ryg_green_male = FHDReportMaterializedCol('ryg_green_male')
    ryg_green_female = FHDReportMaterializedCol('ryg_green_female')
    tetn_dose1 = FHDReportMaterializedCol('tetn_dose1')
    tetn_dose2 = FHDReportMaterializedCol('tetn_dose2')
    tetn_dose3 = FHDReportMaterializedCol('tetn_dose3')
    tetn_dose4 = FHDReportMaterializedCol('tetn_dose4')
    tetn_dose5 = FHDReportMaterializedCol('tetn_dose5')
    npet_dose1 = FHDReportMaterializedCol('npet_dose1')
    npet_dose2 = FHDReportMaterializedCol('npet_dose2')
    npet_dose3 = FHDReportMaterializedCol('npet_dose3')
    npet_dose4 = FHDReportMaterializedCol('npet_dose4')
    npet_dose5 = FHDReportMaterializedCol('npet_dose5')
    breg_male = FHDReportMaterializedCol('breg_male')
    breg_female = FHDReportMaterializedCol('breg_female')
    ancp_anc1 = FHDReportMaterializedCol('ancp_anc1')
    ancp_anc4 = FHDReportMaterializedCol('ancp_anc4')
    ancp_ipt1 = FHDReportMaterializedCol('ancp_ipt1')
    ancp_ipt2 = FHDReportMaterializedCol('ancp_ipt2')
    heid_male = FHDReportMaterializedCol('heid_male')
    heid_female = FHDReportMaterializedCol('heid_female')
    heid_tot = FHDReportMaterializedCol('heid_tot')
    heid_women = FHDReportMaterializedCol('heid_women')
    bpbs_bpm = FHDReportMaterializedCol('bpbs_bpm')
    bpbs_bpf = FHDReportMaterializedCol('bpbs_bpf')
    bpbs_bsm = FHDReportMaterializedCol('bpbs_bsm')
    bpbs_bsf = FHDReportMaterializedCol('bpbs_bsf')
